...
FILE *archivo;
archivo=fopen("persistencia.txt","r");
    if(archivo==NULL){//en caso de ausencia de archivo
    archivo=fopen("persistencia.txt","r");//creo el archivo
    fclose(archivo);//cierro el puntero de creación de archivo
    }else{//si hay archivo 
